 ...
 * Get Redux in?
  * use redux-saga
  * get immutable.js in over redux along with redux-immutable, reselect and a toJS HOC for the dumb components
 ...
 * get testing working
   ...
   * e2e testing - how?
 * flow typing
 * ssr: refactor, modularise and folderise the code
 * fix dev ssl 
